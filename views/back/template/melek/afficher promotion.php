...
if(isset($_GET['trier']))
{
  $listepromotion=$promotionC->TrierClient($_GET['champs'],$_GET['ordre']);
}else if(isset($_GET['chercher'])&&isset($_GET['search'])){
  $listepromotion=$promotionC->chercherClient($_GET['chercher'],$_GET['champs'],$_GET['ordre']);
}else{
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="right_col" role="main">
            ...
            <table>
              <tr>
                <form method="GET" action="afficher client.php">
                <td>
                ...
                <td>
                    <select name="champs" class="form-control" style="margin-top: -10px;">
                      <option selected>idPromo</option>
                      <option>idProduit</option>
                      <option>dureePromo</option>
                      <option>pourcentage</option>
                      <option>idCarte</option>
          ...
          <table class="table">
              ...
              <td><?php echo $promotion['idProduit']; ?>    </td>
              <td><?php echo $promotion['dureePromo']; ?></td>
               <td><?php echo $promotion['pourcentage']; ?></td>
               <td><?php echo $promotion['idCarte']; ?></td>
               
                  
                  <td>
                    <a href="supprimer promotion.php?idPromo=<?php echo $promotion['idPromo']; ?>">Supprimer cette promotion</a>
                  </td>
              </tr>
                <?php
              }
