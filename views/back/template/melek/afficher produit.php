      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="right_col" role="main">
            ...
            <table>
              <tr>
                <form method="GET" action="afficher carte.php">
                <td>
          ...
          <table class="table">
			...
			?>
				<tr>
					...
					<td><?PHP echo $produit['nomPrdt']; ?></td>
					<td><?PHP echo $produit['type_produit']; ?></td>
					<td><?PHP echo $produit['prix']; ?></td>
					<td><?PHP echo $produit['dateExpr']; ?></td>
          <td><?PHP echo $produit['quantite']; ?></td>


          <td>
                    <a href="supprimer produit.php?idProduit=<?php echo $produit['idProduit']; ?>">Supprimer ce produit</a>
                  </td>
