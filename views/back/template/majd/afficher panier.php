                ...
                <div class="content-wrapper">
                    ...
                    <div class="right_col" role="main">
                        ...
                        <table>
                            ...
                            $query = "SELECT * FROM panier"; //You don't need a ; like you do in SQL
                            $result = $conn->query($query);

                            echo "<table class=\"table\" id=\"myTable\">"; // start a table tag in the HTML
                            echo "<tr>";
                            echo "<th onclick='sortTable(0)'>idPanier</th>";
                            echo "<th onclick='sortTable(1)'>idProduit</th>";
                            echo "<th onclick='sortTable(2)'>quantite</th>";
                            echo "<th onclick='sortTable(3)'>idCommande</th>";
                            echo "<th>Operations</th>";

                            while ($row = $result->fetch_row()) {   //Creates a loop to loop through results
                                echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td><a href='supprimerPanier.php?id=$row[0]'>Supprimer</a></td>";  //$row['index'] the index here is a field name
                            }
