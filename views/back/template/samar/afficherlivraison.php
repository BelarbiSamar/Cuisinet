<?PHP
include 'C:/xampp/htdocs/client/controller/livraisonC.php';
include_once 'C:/xampp/htdocs/client/model/livraison.php';
session_start();
...
if(isset($_GET['trier']))
{
  $listelivraison=$livraisonC->Trierlivraison($_GET['champs'],$_GET['ordre']);
}else if(isset($_GET['chercher'])&&isset($_GET['search'])){
  $listelivraison=$livraisonC->chercherlivraison($_GET['chercher'],$_GET['champs'],$_GET['ordre']);
}else{
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="right_col" role="main">
            ...
            <table>
              <tr>
                <form method="GET" action="afficherlivraison.php">
                <td>
                ...
                <td>
                    <select name="champs" class="form-control" style="margin-top: -10px;">
                      <option selected>idLivraison</option>
                      <option>idCommande</option>
                      <option>idLivreur</option>
                      <option>adresseLivraison</option>
                      <option>duréeLivraison</option>
          ...
          <table class="table">
              ...
              <td><?php echo $livraison['idLivreur']; ?></td>
               <td><?php echo $livraison['adresseLivraison']; ?></td>
               <td><?php echo $livraison['dureeLivraison']; ?></td>
               <td><?php echo $livraison['idClient']; ?></td>
               
                  
                  <td>
                    <a href="supprimerlivraison.php?idLivraison=<?php echo $livraison['idLivraison']; ?>">Supprimer cette livraison</a>
                  </td>
              </tr>
                <?php
              }
