<?php
include 'C:/xampp/htdocs/client/controller/pointsrelaisC.php';
include_once 'C:/xampp/htdocs/client/model/pointsrelais.php';
session_start();
...
$pointsrelais = $pointsrelaisC->recupererpointsrelais($_POST["idRelais"]);
