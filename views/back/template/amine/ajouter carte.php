...
$Carte = new Carte();
$CarteC= new CarteC();
if(!empty($_POST["idCarte"]) && !empty($_POST["IdClient"]) && !empty($_POST["type"]) && !empty($_POST["nbPoints"]) 
&& !empty($_POST["DateEm"]) && !empty($_POST["DateExp"]))
{if(isset($_POST["idCarte"]) && isset($_POST["IdClient"]) && isset($_POST["type"]) && isset($_POST["nbPoints"]) 
&& isset($_POST["DateEm"]) && isset($_POST["DateExp"])&& isset($_POST["Ajouter"]) )
{
    $Carte->idCarte=$_POST['idCarte'];
    $Carte->IdClient=$_POST['IdClient'];
    $Carte->type=$_POST['type'];
    $Carte->nbPoints=$_POST['nbPoints'];
    $Carte->DateEm=$_POST['DateEm'];
    $Carte->DateExp=$_POST['DateExp'];
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <td>Id Carte : </td><td><input type="text" name="idCarte" id="idCarte" class="form-control" > </td>
          </tr>
          <tr><td>Id Client : </td>
                                <?php
          ...
          <tr><td>type : </td><td><input type="text" name="type" id="type" class="form-control" > </td>
          </tr>
           <tr><td>nombre de points : </td><td><input type="text" id="nbPoints" name="nbPoints" class="form-control"  > </td>
          </tr>
          <tr><td>date d'émmission : </td><td><input type="date" name="DateEm" id="DateEm" class="form-control"  > </td></tr>
          </tr>
          <tr><td>date d'expiration : </td><td><input type="date" name="DateExp" id="DateExp" class="form-control"  > </td></tr>
          </tr>
              <tr>
