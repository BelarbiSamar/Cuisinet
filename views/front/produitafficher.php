...
require("C:/xampp/htdocs/client/views/front/produits.php");
include 'C:\xampp\htdocs\client\model\panier.php';
require 'C:\xampp\htdocs\client\config.php';
...
if(isset($_GET['trier']))
{
  $Produits=TrierClient($_GET['champs'],$_GET['ordre']);
}else if(isset($_GET['chercher'])&&isset($_GET['search'])){
  $Produits=chercherClient($_GET['chercher'],$_GET['champs'],$_GET['ordre']);
}else{
  $Produits=afficher();}
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="produitafficher.php">Fashon Category</a>
					</nav>
				</div>
			</div>
		</div>
...
<div class="album py-5 bg-light">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <title><?= $produit->nomPrdt ?></title>
            <img src="<?= $produit->dateExpr ?>">

            <div class="card-body">
              <p class="card-text"><?= substr($produit->type_produit, 0, 200); ?></p>
              <div class="d-flex justify-content-between align-items-center">
                <a class="add" href="cart.php?idProduit=<?php $produit->idProduit ?>">
					<div class="btn-group">
                  <button type="submit" name="add" method="GET" class="btn btn-sm btn-outline-secondary">Add</button>
                </div>
					</a>
                <h3 class="text-muted"><?= $produit->prix ?> dinars+20%promo</h3>
