                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            ...
                            <div class="profile-name">
                                <h5 class="mb-0 font-weight-normal">Med Majd Makhloufi</h5>
                                <span></span>
                            </div>
                        </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                                <div class="navbar-profile">
                                    <img class="img-xs rounded-circle" src="assets/images/faces/face15.jpg" alt="">
                                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Med Majd Makhloufi</p>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="right_col" role="main">
                        ...
                        <table>
                                ...
                                <form method="GET" action="afficherclient.php">
                                    ...
                                    <td>
                                        <select name="champs" class="form-control" style="margin-top: -10px;">
                                            ...
                                            <option>nombre article</option>
                                            <option value="date emmission">date de commande</option>
                                        </select>
                                    </td>
                            ...
                            $query = "SELECT * FROM commande"; //You don't need a ; like you do in SQL
                            $result = $conn->query($query);

                            echo "<table class=\"table\" id=\"myTable\">"; // start a table tag in the HTML
                            echo "<tr>";
                            echo "<th onclick='sortTable(0)'>idCommande</th>";
                            echo "<th onclick='sortTable(1)'>dateCmd</th>";
                            echo "<th onclick='sortTable(2)'>nbArticle</th>";
                            echo "<th onclick='sortTable(3)'>idClient</th>";
                            echo "<th onclick='sortTable(4)'>idProduit</th>";
                            echo "<th>Operations</th>";

                            while ($row = $result->fetch_row()) {   //Creates a loop to loop through results
                                echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>". $row[3] ."</td><td>". $row[4] ."</td><td><a href='supprimerCommande.php?id=$row[0]'>Supprimer</a></td>";  //$row['index'] the index here is a field name
                            }
