...
include_once 'C:/xampp/htdocs/client/model/Client.php';
session_start();
...
if(isset($_GET['trier']))
{
  $listeClients=$ClientC->TrierClient($_GET['champs'],$_GET['ordre']);
}else if(isset($_GET['chercher'])&&isset($_GET['search'])){
  $listeClients=$ClientC->chercherClient($_GET['chercher'],$_GET['champs']);
}else{
        ...
        <div class="content-wrapper">
              ...
              <tr>
                ...
                <td>
                    <select name="champs" class="form-control" style="margin-top: -10px;">
                      ...
                      <option value="dateN">date de naissance</option>
          ...
          <table class="table">
              ...
              <td><?php echo $Clients['nom']; ?></td>
               ...
               <td><?php echo $Clients['dateNaiss']; ?></td>
               <td><?php echo $Clients['password']; ?></td>
                  
                  <td>
                    <a href="supprimer client.php?id=<?php echo $Clients['id']; ?>">Supprimer ce client</a>
                  </td>
              </tr>
                <?php
              }
