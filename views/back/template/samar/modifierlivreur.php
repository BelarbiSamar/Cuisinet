...
include 'C:/xampp/htdocs/client/controller/livreurC.php';
include_once 'C:/xampp/htdocs/client/model/livreur.php';
session_start();
...
if (
  ...
  isset($_POST["idLivreur"]) && isset($_POST["recupere"])
...
$livreur = $livreurC->recupererlivreur($_POST["idLivreur"]);
...
if(isset($_POST['Modifier']))
{
  ...
  $livreurC->modifierlivreur($_POST["idLivreur"]);
