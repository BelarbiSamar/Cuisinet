...
include_once 'C:/xampp/htdocs/client/model/Carte.php';
session_start();
...
$CarteC=new CarteC();
$listeCartes=$CarteC->afficherCartes();
      ...
      <div class="main-panel">
        <div class="content-wrapper">
              ...
              <tr>
                ...
                <td>
                    <select name="champs" class="form-control" style="margin-top: -10px;">
                      <option selected>id Carte</option>
                      <option>Id Client</option>
                      <option>type</option>
                      <option>nb points</option>
          ...
          <table class="table">
              ...
              ?>
              <tr>
                  <td><?php echo $Cartes['idCarte']; ?></td>
              <td><?php echo $Cartes['IdClient']; ?>  </td>
              <td><?php echo $Cartes['type']; ?></td>
               <td><?php echo $Cartes['nbPoints']; ?></td>
               <td><?php echo $Cartes['DateEm']; ?></td>
               <td><?php echo $Cartes['DateExp']; ?></td>
               
                  
                  <td>
                    <a href="supprimer carte.php?idCarte=<?php echo $Cartes['idCarte']; ?>">Supprimer cette carte</a>
                  </td>
              </tr>
              <?php
              }
