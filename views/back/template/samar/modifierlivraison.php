...
if (
  ...
  isset($_POST["idLivraison"]) && isset($_POST["recupere"])
...
$_POST["dureeLivraison"],
$_POST["idClient"]
);



$livraison = $livraisonC->recupererlivraison($_POST["idLivraison"]);
        ...
        <div class="content-wrapper">
          ...
          <select name="idCommande" id="idCommande" class="form-control">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo ' <option name="idCommande" id="idCommande" class="form-control" value="' . $idCommande	 . '">' . $idCommande	 . '</option> ';
                                    } ?>
                                </select>
          </tr>
          <tr><td>Id Livreur : </td>
                                ...
                                $sql = "SELECT idLivreur from livreur";
                                $result = $conn->query($sql);
          ...
          <select name="idLivreur" id="idLivreur" class="form-control">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo ' <option name="idLivreur" id="idLivreur" class="form-control" value="' . $idLivreur . '">' . $idLivreur . '</option> ';
                                    } ?>
                                </select>
          </tr>
          ...
          <select name="IdClient" id="IdClient" class="form-control">
              ...
              <tr>
                            <td colspan="2">  <button type="submit" class="form-control" name="recupere">
                                                        actualiser
                                                    </button></td>
              </tr>
              <tr>
