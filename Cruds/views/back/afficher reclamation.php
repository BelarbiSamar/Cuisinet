            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic" style="">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="modifier reclamation.html">Modifier Reclamation</a></li>
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link collapsed" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                        ...
                        <span class="menu-title">Gestion des reparations</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="collapse" id="ui-basic" style="">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="ajouter reparation.html">Ajouter Reparation</a></li>
                            <li class="nav-item"> <a class="nav-link" href="modifier reparation.html">Modifier Reparation</a></li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="right_col" role="main">
                        ...
                        <table>
                            ...
                            $query = "SELECT * FROM reclamation"; //You don't need a ; like you do in SQL
                            ...
                            echo "<th onclick='sortTable(2)'>Description</th>";
                            echo "<th onclick='sortTable(3)'>CIN Client</th>";
                            echo "<th>Operations</th>";

                            while ($row = $result->fetch_row()) {   //Creates a loop to loop through results
                                echo "<tr><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td><a href='supprimerReclamation.php?id=$row[0]'>Supprimer</a>";  //$row['index'] the index here is a field name
                            }
