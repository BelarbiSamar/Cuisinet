...
require("C:/xampp/htdocs/Taches_Dhia/Cruds/views/front/recipe.php");

if (isset($_GET['trier'])) {
	$recipe = TrierRecipe($_GET['champs'], $_GET['ordre']);
} else if (isset($_GET['chercher']) && isset($_GET['search'])) {
	$recipe = chercherRecipe($_GET['chercher'], $_GET['champs'], $_GET['ordre']);
} else {
	$recipe = afficher();
}
...
<body>
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="category.html">Recipes</a>
					</nav>
				</div>
			</div>
		</div>
	...
	<div class="input-group">
		<input id="searchbar" onkeyup="search()" type="text" class="form-control" placeholder="Search Posts" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Posts'">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<?php foreach ($recipe as $recipes) : ?>
						<div class="col-md-9" id="myUL">
							<div class="blog_post">
								<img src="<?= $recipes->nomChef ?>" alt="">
	...
	<script>
		function search() {
			...
			let x = document.getElementsByClassName('col-md-9');
